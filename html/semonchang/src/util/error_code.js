//默认错误消息，如果没有找到就返回此条消息
const DEFAULT_MESSAGE = "Oops!something go wrong";
const errorCode = {};
const codeInfoMap = [];
...
/** 其它前端请求网络错误 */
errorCode.HTTP_NETWORK_ERR = defineCode(
  1005,
  "Sorry, the internet connection failed."
);
...
/** 还没回包，又发送了相同的请求 */
errorCode.DUPLICATE_REQUEST = defineCode(
  1007,
